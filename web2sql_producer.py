...
from FutureContract import to_raw_dict
...
def sql2web_produce(objects=None,list_items=None):
    p = Producer(KafkaServer="192.168.23.179", KafkaPort="9092", Topic='web2sql')
    if objects is not None:
        for obj in objects:
            p.sendMsg(obj.to_raw_dict())
